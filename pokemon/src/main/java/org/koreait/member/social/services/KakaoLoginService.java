...
public class KakaoLoginService implements SocialLoginService {
    ...
    public String getToken(String code) {
        ...
        params.add("redirect_uri", utils.getUrl("/member/social/"));
    ...
    public String getLoginUrl(String redirectUrl) {
        ...
        return String.format("https://kauth.kakao.com/oauth/authorize?client_id=%s&redirect_uri=%s&response_type=code%s", restApiKey, redirectUri, redirectUrl);
    }
