...
public class PythonRunTest {
    ...
    void test1() throws Exception{
        ProcessBuilder builder = new ProcessBuilder("python.exe", "D:/recommend/train.py", "http://localhost:3000/api/dl/data");
    ...
    void test2() throws Exception{
        ProcessBuilder builder = new ProcessBuilder("python.exe", "D:/recommend/train.py", "[[ 1.23151481,  0.88790998,  1.6140196,   0.94127238,  1.6784415,   1.38504672, -1.57161094, -0.65513703,  0.99961796 , -0.80484811]]");
        Process process = builder.start();
        BufferedReader reader = process.inputReader();
        reader.lines().forEach(System.out::println);
        int exitCode = process.waitFor();
