...
@SessionAttributes({"requestAgree", "requestLogin"}) // 커맨드 객체 끌어오?기
public class MemberController {
     ...
     */
    @PostMapping("/join_ps")
    public String joinPs(@SessionAttribute("requestAgree") /* 이게.. 매..매라꼬..? */ RequestAgree agree, @Valid RequestJoin form, Errors errors, SessionStatus status, Model model) {
    ...
    @ResponseBody
    @GetMapping("/refresh")
    @PreAuthorize("isAuthenticated()") // 실행 전 권한체크, 수동으로 인증처리
